...
class Baxter:
    def __init__(self, sim):
        ...
        self.unknown_left = [0.0, 0.5235987901687622, 3.0541799068450928,
                             1.0471975803375244, 0.0, -0.7853981852531433, 0.0]
        self.unknown_right = [0.0, 0.5235987901687622, 3.0541799068450928,
                              1.0471975803375244, 0.0, -0.7853981852531433, 0.0]
    ...
    def dunno(self):
        """
        Action that describe that Baxter cannot execute that specific action,
        maybe because it doesn't have the necessary ingredients,
        or because the request doesn't make sense.
        """
        self.baxter_left.set_joint_target_positions(self.unknown_left)
        self.baxter_right.set_joint_target_positions(self.unknown_right)
        for i in range(100):
            self.sim.sim.step()
    ...
    def serve(self):
        ...
        self.move(self.sim.waypoints[0], ignore_collision=True)
        self.move(self.sim.waypoints[1], ignore_collision=True)
